...
const CardPlot = ({ plot }: CardPlotProps) => {
  ...
  // const parcelleComporteAuMoinsUnRosierNonArchiveDontLeDelaiEditionEstEcoule =
  //   observationsByRosierID &&
  //   observationsByRosierID.length > 0 &&
  //   observationsByRosierID.some(
  //     obs => !obs.rosier_est_archive && obs.delai_passed
  //   );

  // Si la parcelle ne comporte aucun rosier non archivé dont le délai d’édition* est écoulé.
  // const parcelleNeComporteAucunRosierNonArchiveDontLeDelaiEditionEstEcoule =
  //   observationsByRosierID &&
  //   observationsByRosierID.length > 0 &&
  //   observationsByRosierID.every(
  //     obs => obs.rosier_est_archive && obs.delai_passed
  //   );
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <>
              {/* Icon todo */}
              {!plot.est_archive && rosierDelayEditionPassed == true && (
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
              ...
              {/* Icon ok */}
              {!plot.est_archive && rosierDelayEditionPassed == false && (
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
